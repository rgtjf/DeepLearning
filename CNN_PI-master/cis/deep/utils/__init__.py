...
def are_generators_equal(gen1, gen2):
    ...
    return all(a == b for a, b in
                zip_longest(gen1, gen2, fillvalue=object()))
...
def save_object_to_file(obj, filename):
    ...
    """
    # Caution: using utf8_file_open doesn't work with cPickle
    pickle.dump(obj, open(filename, "wb"), protocol=-1)
...
def sort_dict_by_key(d, reverse=False):
    ...
    [('e', 4), ('d', 3), ('c', 2), ('b', 1), ('a', 0)]
    """
    return sorted(iter(list(d.items())), key=itemgetter(0), reverse=reverse)
...
def sort_dict_by_label(d, reverse=False):
    ...
    [('e', 4), ('d', 3), ('c', 2), ('b', 1), ('a', 0)]
    """
    return sorted(iter(list(d.items())), key=itemgetter(1), reverse=reverse)

def text_to_vocab_indices(vocab, tokens, unk='<UNK>'):
    """
